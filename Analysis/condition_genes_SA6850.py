...
cluster_1_id = df[df["cond_clusters"] == 1]
cluster_2_id = df[df["cond_clusters"] == 2]
...
fig.savefig('../Out/condition_SA6850_all.eps', format='eps')
...
fig.savefig('../Out/condition_SA6850_unique.eps', format='eps')
...
# write it to file
with open("../Out/SA6850/mutated_genes_SA6850_condition.txt", 'w') as f:
...
# store gff file
gff.to_csv('../Out/SA6850/gff_SA6850.csv')